...
## [0.5.5](https://github.com/caunt/Void/compare/v0.5.4...v0.5.5) (2025-09-06)
...
* **api:** 🐛 correct log argument for canceled task ([34ebd58](https://github.com/caunt/Void/commit/34ebd58c76020e6e2568df59ca34be96a20d72a7))
...
* **api:** 📝 correct malformed param documentation ([e3b96d7](https://github.com/caunt/Void/commit/e3b96d787d968eabb32dd15c4984c3b2def57aee))
...
* **minecraft:** 🐛 correct default count for ShowItem hover action ([eb04706](https://github.com/caunt/Void/commit/eb04706f833cfe9aa5bad4c84fc583564447f13c))
...
* **nbt:** 🐛 handle invalid token in boolean adapter ([15ca7dd](https://github.com/caunt/Void/commit/15ca7ddf9fabfb6ce2783bcdcfaaa3a9df4afe0c))
...
* **plugins:** 🐛 ensure transformation mappings sort equality ([984d880](https://github.com/caunt/Void/commit/984d880dea4c747aa5115c80cb96a4c30e500e18))
...
* **plugins:** 🐛 use nameof for protocol version check ([3179094](https://github.com/caunt/Void/commit/31790942d790b58cf56d361fd9c96f7749d9656c))
...
* **protocol-support:** 🛠️ add 1.21.6 chat command mapping ([c276d96](https://github.com/caunt/Void/commit/c276d9637c8e8c6afd8befbd2ee11416fc383dec))
...
* **protocolsupport:** 🐛 use specific exception for missing level type ([22e605b](https://github.com/caunt/Void/commit/22e605ba83858ef4a38fab043d6ac14c83b16c3d))
...
* **velocity:** 🐛 handle HMAC hash failure ([4fba988](https://github.com/caunt/Void/commit/4fba988dca63d4e1d7e070092867309d5b1a4393))


### Performance Improvements

* **buffer:** ⚡ optimize memory usage with stackalloc ([d80cf42](https://github.com/caunt/Void/commit/d80cf4272b12676635373cfdd4fca0d3a51b3637))
...
* **buffers:** ⚡️ avoid heap allocation in WriteVarInt ([07ac28d](https://github.com/caunt/Void/commit/07ac28d93206406d7e7776722dc76f93b7a04d28))
* **buffers:** ⚡️ avoid heap allocation when encoding UTF-8 strings ([f5352c7](https://github.com/caunt/Void/commit/f5352c7b96eed96312f45bf6c05ff74d556330d2))
* **buffers:** ⚡ replace byte array allocation with stackalloc ([49f6789](https://github.com/caunt/Void/commit/49f6789f648eecf2aa461baa77c2c3910354c002))
* **buffers:** ⚡ use stackalloc for string encoding ([ff23da1](https://github.com/caunt/Void/commit/ff23da156f6d104a258853e14999cf52042661b2))
* **buffers:** ⚡️ use stackalloc for UUID serialization ([7dea08b](https://github.com/caunt/Void/commit/7dea08b472d9100b7afd7e0fbbd5b950f38a4873))
...
* **common:** ⚡ replace byte array pool with stackalloc ([78d2576](https://github.com/caunt/Void/commit/78d2576cf322e41c404c75dd4d56ade44e8f4e4e))
...
* **encryption:** ⚡ avoid heap allocation when verifying token ([5135ab8](https://github.com/caunt/Void/commit/5135ab87c5a7e509c25642ca6d36b9ab6cf7c24d))
* **encryption:** ⚡ use stackalloc for salt bytes ([e9c2c07](https://github.com/caunt/Void/commit/e9c2c07b83193c63eba69c88db44c0f192c83f87))
...
* **minecraft:** ♻️ use stackalloc to avoid byte array allocation ([e5d7eb1](https://github.com/caunt/Void/commit/e5d7eb1a7a341c0b95419dcf02ec5d068fb10772))
...
* **minecraft:** ⚡ avoid heap allocation for long property ([26ec00a](https://github.com/caunt/Void/commit/26ec00afcb91bbae93fb22fcad98a92ce3e0d10d))
* **minecraft:** ⚡ avoid heap allocation in UUID parsing ([1a34ad0](https://github.com/caunt/Void/commit/1a34ad0f3f555fef04380dc4447d3d66ada2fccd))
...
* **minecraft:** ⚡️ eliminate allocation in offline UUID ([eac092f](https://github.com/caunt/Void/commit/eac092f7936b08129e93f3ad29f6e29a60110cf8))
* **minecraft:** ⚡ simplify command source comparison ([682b998](https://github.com/caunt/Void/commit/682b9980e8be42424a10d0edbeec84afe9cef667))
* **minecraft:** ⚡️ stackalloc WriteUuid ([0e51dbe](https://github.com/caunt/Void/commit/0e51dbecbc778f8660cca3be01fc91664ce2813f))
* **minecraft:** ⚡️ use stackalloc for UUID part parsing ([677dbb7](https://github.com/caunt/Void/commit/677dbb7bd809eaf5c3ee664582fbfa993bc7d41b))
* **minecraft:** 🚀 use stackalloc in UUID parsing ([9ae1ecb](https://github.com/caunt/Void/commit/9ae1ecbe464afd3e40d61d7ac00222f042bc2c8d))
* **mojang:** ⚡ avoid heap allocation during SHA1 hashing ([e6f6772](https://github.com/caunt/Void/commit/e6f67723b389d511cc5d60f76ccc6a67cfb798d1))
* **mojang:** ⚡ reduce heap allocation during session verification ([d14bb6d](https://github.com/caunt/Void/commit/d14bb6d2ebf5ba79552f106a82fa556f9f389a53))
...
* **platform:** ⚡ avoid array allocation in endpoint parser ([65bfc4a](https://github.com/caunt/Void/commit/65bfc4add49266e9a511a8e394200378283e8ca3))
* **platform:** ⚡ avoid heap allocation in IP address converter ([f76c711](https://github.com/caunt/Void/commit/f76c711b1436ab1b10b65439b111e8a5f2d2c15f))
* **platform:** ⚡ replace array allocations with stackalloc ([64a53a0](https://github.com/caunt/Void/commit/64a53a08bcefd8f0fbb764f9360e2364b8c7efa6))
* **platform:** ⚡ replace byte array allocation with stackalloc ([3a855f4](https://github.com/caunt/Void/commit/3a855f4a9be9725ae1aa520c7cf25fe7e4d7500e))
...
* **profiles:** ⚡ replace byte array allocation with stackalloc ([ec32e13](https://github.com/caunt/Void/commit/ec32e1326398f8f68be8adbcd86c6d70ca9a74fd))
* **profiles:** ⚡️ use stackalloc for int part bytes ([c476d63](https://github.com/caunt/Void/commit/c476d6368c61c5521af703d7b42b8a88cbb946c9))
* **profiles:** ⚡ use stackalloc for key verification ([decadf2](https://github.com/caunt/Void/commit/decadf268f04e071b965c0def693f78d35f15f07))
* **protocolsupport:** ⚡ stackalloc acknowledged bytes ([7d6cbe7](https://github.com/caunt/Void/commit/7d6cbe7911b56bbb01ce1486c71b7d53eb282d98))
...
* **tests:** ⚡ use stackalloc for slice assertion ([3328ee4](https://github.com/caunt/Void/commit/3328ee412cef44552027fe924b4cda8f9ac5b9f8))
...
* **transformations:** ⚡️ reduce allocations when creating byte property ([b14210f](https://github.com/caunt/Void/commit/b14210fc1d174fc05337bfcc2482f4409cf0eeb8))
* **velocity:** ⚡️ stackalloc secret bytes to avoid heap allocation ([9f77993](https://github.com/caunt/Void/commit/9f779932a70842c6afe4ba55337fe0f1df87e334))
* **velocity:** ⚡️ use stackalloc for HMAC signature ([c87cf99](https://github.com/caunt/Void/commit/c87cf9967a27a0d73c6e4c0afcfaa14a194d3d46))
