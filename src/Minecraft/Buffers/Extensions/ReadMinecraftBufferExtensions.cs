...
public static class ReadMinecraftBufferExtensions
{
    ...
    public static byte ReadByte<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
    ...
    public static ushort ReadUnsignedShort<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadUInt16BigEndian(buffer.Read(2));
    }
    ...
    public static short ReadShort<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadInt16BigEndian(buffer.Read(2));
    }
    ...
    public static int ReadInt<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadInt32BigEndian(buffer.Read(4));
    }
    ...
    public static float ReadFloat<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadSingleBigEndian(buffer.Read(4));
    }
    ...
    public static double ReadDouble<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadDoubleBigEndian(buffer.Read(8));
    }
    ...
    public static long ReadLong<TBuffer>(ref this TBuffer buffer) where TBuffer : struct, IMinecraftBuffer<TBuffer>, allows ref struct
    {
        return BinaryPrimitives.ReadInt64BigEndian(buffer.Read(8));
    }
