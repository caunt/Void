...
/// <summary>Represents a signed 16-bit integer NBT tag.</summary>
/// <param name="Value">The numeric value.</param>
public record NbtShort(short Value) : NbtTag
{
    /// <summary>Converts a SharpNBT short tag while preserving its name and value.</summary>
    ...
    /// <summary>Converts to a SharpNBT short tag while preserving the name and value.</summary>
    /// <param name="tag">The source tag.</param>
    /// <returns>The converted tag.</returns>
