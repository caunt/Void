...
/// <summary>Declares a resource-or-tag-key argument for a specific registry.</summary>
...
{
    /// <summary>Reads and writes the registry identifier for resource-or-tag-key arguments.</summary>
