...
public partial class Settings(IniData data)
{
    ...
    private void Load()
    {
        var global = data.Sections.ContainsSection("SETTINGS") ? data.Sections.GetSectionData("SETTINGS") : new SectionData("SETTINGS") { Keys = data.Global };
    ...
    private void FillIniData()
    {
        ...
        var forwardingLegacySection = data.Sections.ContainsSection("FORWARDING.LEGACY") ? data.Sections.GetSectionData("FORWARDING.LEGACY") : new SectionData("FORWARDING.LEGACY");
        ...
        var serversSection = data.Sections.ContainsSection("SERVERS") ? data.Sections.GetSectionData("SERVERS") : new SectionData("SERVERS");
