...
public class ProxiedServerRedirectionTests(ProxiedServerRedirectionTests.TwoPaperServerFixture fixture) : ConnectionUnitBase, IClassFixture<ProxiedServerRedirectionTests.TwoPaperServerFixture>
{
    ...
    public class TwoPaperServerFixture : ConnectionFixtureBase, IAsyncLifetime
    {
        public TwoPaperServerFixture() : base(nameof(ProxiedServerRedirectionTests))
        {
        }
        ...
        public async Task InitializeAsync()
        {
            ...
            PaperServer1 = await PaperServer.CreateAsync(_workingDirectory, _httpClient, name: "PaperServer1", port: Server1Port, cancellationToken: cancellationTokenSource.Token);
            PaperServer2 = await PaperServer.CreateAsync(_workingDirectory, _httpClient, name: "PaperServer2", port: Server2Port, cancellationToken: cancellationTokenSource.Token);
