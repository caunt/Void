...
public class PaperServer : IntegrationSideBase
{
    ...
    public static async Task<PaperServer> CreateAsync(string workingDirectory, HttpClient client, int port = 25565, string instanceName = nameof(PaperServer), PaperPlugins plugins = PaperPlugins.All, CancellationToken cancellationToken = default)
    {
