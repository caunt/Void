...
public class PaperServer : IntegrationSideBase
{
    ...
    public static async Task<PaperServer> CreateAsync(string workingDirectory, HttpClient client, string name = nameof(PaperServer), int port = 25565, PaperPlugins plugins = PaperPlugins.All, CancellationToken cancellationToken = default)
    {
