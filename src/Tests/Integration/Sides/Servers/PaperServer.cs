...
public class PaperServer : IntegrationSideBase
{
    ...
    public static async Task<PaperServer> CreateAsync(string workingDirectory, HttpClient client, string instanceName = "PaperServer", int port = 25565, PaperPlugins plugins = PaperPlugins.All, string? paperVersion = null, CancellationToken cancellationToken = default)
    {
        ...
        var versionToUse = paperVersion ?? latestVersion;

        var buildsJson = await client.GetStringAsync($"https://api.papermc.io/v2/projects/paper/versions/{versionToUse}", cancellationToken);
        ...
        var buildInfoJson = await client.GetStringAsync($"https://api.papermc.io/v2/projects/paper/versions/{versionToUse}/builds/{latestBuild}", cancellationToken);
        ...
        var paperUrl = $"https://api.papermc.io/v2/projects/paper/versions/{versionToUse}/builds/{latestBuild}/downloads/{jarName}";
