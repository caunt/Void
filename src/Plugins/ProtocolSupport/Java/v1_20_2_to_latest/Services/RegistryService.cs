    ...
    public void OnMessageReceived(MessageReceivedEvent @event, CancellationToken cancellationToken)
    {
        switch (@event.Message)
        {
            ...
            case LoginAcknowledgedPacket:
                SetRegistry(@event.Link.Player, Direction.Clientbound, Mappings.ClientboundConfigurationMappings);
                break;
    ...
    public void OnMessageSent(MessageSentEvent @event, CancellationToken cancellationToken)
    {
        switch (@event.Message)
        {
            case HandshakePacket handshake:
                ...
                break;
            case LoginAcknowledgedPacket:
                SetRegistry(@event.Link.Player, Direction.Serverbound, Mappings.ServerboundConfigurationMappings);
                break;
            case FinishConfigurationPacket:
