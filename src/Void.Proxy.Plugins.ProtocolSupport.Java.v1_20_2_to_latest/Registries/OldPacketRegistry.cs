...
public class OldPacketRegistry
{
    ...
    public void Register<T>(Func<T> factory, params PacketMapping[] mappings) where T : IMinecraftPacket
    {
        ...
        for (var i = 0; i < mappings.Length; i++)
        {
            ...
            var to = current.Equals(next) ? lastValid ?? ProtocolVersion.Latest : next.ProtocolVersion;
