# <a id="Void_Minecraft_Nbt_Tags_NbtEnd"></a> Class NbtEnd
...
[IEquatable<NbtEnd\>](https://learn.microsoft.com/dotnet/api/system.iequatable\-1)
...
### <a id="Void_Minecraft_Nbt_Tags_NbtEnd_ToString"></a> ToString\(\)
...
### <a id="Void_Minecraft_Nbt_Tags_NbtEnd_op_Implicit_Void_Minecraft_Nbt_EndTag__Void_Minecraft_Nbt_Tags_NbtEnd"></a> implicit operator NbtEnd\(EndTag\)
...
`_` [EndTag](Void.Minecraft.Nbt.EndTag.md)

#### Returns

 [NbtEnd](Void.Minecraft.Nbt.Tags.NbtEnd.md)

### <a id="Void_Minecraft_Nbt_Tags_NbtEnd_op_Implicit_Void_Minecraft_Nbt_Tags_NbtEnd__Void_Minecraft_Nbt_EndTag"></a> implicit operator EndTag\(NbtEnd\)
...
`_` [NbtEnd](Void.Minecraft.Nbt.Tags.NbtEnd.md)
