...
Reads a Minecraft protocol string encoded as a <code>VarInt</code> byte length followed by UTF-8 bytes.
...
The decoded UTF-8 string. The returned value is never <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/keywords/null">null</a>.

#### Examples

<pre><code class="lang-csharp">var text = buffer.ReadString(16);</code></pre>

#### Remarks

<p>
This method validates the decoded character length, not the encoded byte length. If <code class="paramref">maxLength</code> is less than or equal to <code>0</code>, length validation is skipped.
</p>
<p>
...
The length prefix is not a valid Minecraft <code>VarInt</code> value.

 [IndexOutOfRangeException](https://learn.microsoft.com/dotnet/api/system.indexoutofrangeexception)

The decoded string length exceeds <code class="paramref">maxLength</code>.

 [ReadOnlyException](https://learn.microsoft.com/dotnet/api/system.data.readonlyexception)

Propagated from the underlying buffer implementation in unsupported scenarios.

#### See Also

[MinecraftBuffer](Void.Minecraft.Buffers.MinecraftBuffer.md).[ReadVarInt](Void.Minecraft.Buffers.MinecraftBuffer.md\#Void\_Minecraft\_Buffers\_MinecraftBuffer\_ReadVarInt)\(\)
...
The properties to serialize. When <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/keywords/null">null</a>, an empty array is written.

#### Examples

<pre><code class="lang-csharp">buffer.WritePropertyArray(profile.Properties);</code></pre>

#### Remarks

<p>
This method writes a VarInt element count first, then serializes each <xref href="Void.Minecraft.Profiles.Property" data-throw-if-not-resolved="false"></xref> by calling
<xref href="Void.Minecraft.Buffers.MinecraftBuffer.WriteProperty(Void.Minecraft.Profiles.Property)" data-throw-if-not-resolved="false"></xref>.
</p>
<p>
Passing <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/keywords/null">null</a> is equivalent to passing <code>[]</code>, so the written count is <code>0</code>.
</p>
...
Propagated from <xref href="Void.Minecraft.Buffers.MinecraftBuffer.WriteProperty(Void.Minecraft.Profiles.Property)" data-throw-if-not-resolved="false"></xref> when a property is marked as signed but has a missing
or whitespace signature.

#### See Also

[MinecraftBuffer](Void.Minecraft.Buffers.MinecraftBuffer.md).[ReadPropertyArray](Void.Minecraft.Buffers.MinecraftBuffer.md\#Void\_Minecraft\_Buffers\_MinecraftBuffer\_ReadPropertyArray)\(\)
...
Writes a Minecraft protocol string as UTF-8 bytes prefixed by its byte length encoded as <code>VarInt</code>.
...
<pre><code class="lang-csharp">buffer.WriteString("minecraft:stone");</code></pre>
...
The underlying backing buffer is read-only.
 ...
 [InternalBufferOverflowException](https://learn.microsoft.com/dotnet/api/system.io.internalbufferoverflowexception)

The target writable span does not have enough capacity for the encoded payload.

#### See Also

[MinecraftBuffer](Void.Minecraft.Buffers.MinecraftBuffer.md).[WriteVarInt](Void.Minecraft.Buffers.MinecraftBuffer.md\#Void\_Minecraft\_Buffers\_MinecraftBuffer\_WriteVarInt\_System\_Int32\_)\([int](https://learn.microsoft.com/dotnet/api/system.int32)\)
