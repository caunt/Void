# <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode"></a> Class ArgumentCommandNode
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode__ctor_System_String_Void_Minecraft_Commands_Brigadier_ArgumentTypes_IArgumentType_Void_Minecraft_Commands_Brigadier_CommandExecutor_Void_Minecraft_Commands_Brigadier_Tree_CommandRequirement_Void_Minecraft_Commands_Brigadier_Tree_CommandNode_Void_Minecraft_Commands_Brigadier_RedirectModifier_System_Boolean_Void_Minecraft_Commands_Brigadier_Suggestion_SuggestionProvider_"></a> ArgumentCommandNode\(string, IArgumentType, CommandExecutor?, CommandRequirement?, CommandNode?, RedirectModifier?, bool, SuggestionProvider?\)
...
`customSuggestions` [SuggestionProvider](Void.Minecraft.Commands.Brigadier.Suggestion.SuggestionProvider.md)?

## Properties

### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_CustomSuggestions"></a> CustomSuggestions
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_Examples"></a> Examples
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_Name"></a> Name
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_SortedKey"></a> SortedKey
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_Type"></a> Type
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_UsageText"></a> UsageText
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_CreateBuilder"></a> CreateBuilder\(\)
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_IsValidInput_System_String_"></a> IsValidInput\(string\)
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_ListSuggestionsAsync_Void_Minecraft_Commands_Brigadier_Context_CommandContext_Void_Minecraft_Commands_Brigadier_Suggestion_SuggestionsBuilder_System_Threading_CancellationToken_"></a> ListSuggestionsAsync\(CommandContext, SuggestionsBuilder, CancellationToken\)
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_Parse_Void_Minecraft_Commands_Brigadier_StringReader_Void_Minecraft_Commands_Brigadier_Context_CommandContextBuilder_"></a> Parse\(StringReader, CommandContextBuilder\)
...
### <a id="Void_Minecraft_Commands_Brigadier_Tree_Nodes_ArgumentCommandNode_ToString"></a> ToString\(\)
