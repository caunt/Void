# <a id="Void_Proxy_Api_Configurations_Attributes_ConfigurationAttribute"></a> Class ConfigurationAttribute

Namespace: [Void.Proxy.Api.Configurations.Attributes](Void.Proxy.Api.Configurations.Attributes.md)  
...
[ConfigurationAttribute](Void.Proxy.Api.Configurations.Attributes.ConfigurationAttribute.md)
...
<pre><code class="lang-csharp">[Configuration("network")]
...
<p>
The <xref href="Void.Proxy.Api.Configurations.Attributes.ConfigurationAttribute.Name" data-throw-if-not-resolved="false"></xref> value is treated as a logical alias and does not rename CLR members.
</p>

## Constructors

### <a id="Void_Proxy_Api_Configurations_Attributes_ConfigurationAttribute__ctor_System_String_"></a> ConfigurationAttribute\(string\)
...
When <code class="paramref">name</code> is <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/keywords/null">null</a>, empty, or whitespace, consumers fall back to the CLR type name.
...
RootConfigurationAttribute, 
[ConfigurationPropertyAttribute](Void.Proxy.Api.Configurations.Attributes.ConfigurationPropertyAttribute.md)

## Properties

### <a id="Void_Proxy_Api_Configurations_Attributes_ConfigurationAttribute_InlineComment"></a> InlineComment
...
### <a id="Void_Proxy_Api_Configurations_Attributes_ConfigurationAttribute_Name"></a> Name
...
<p>
The property is <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/keywords/init">init</a>-only, so it can be assigned during attribute construction and object initialization.
</p>
...
### <a id="Void_Proxy_Api_Configurations_Attributes_ConfigurationAttribute_PrecedingComment"></a> PrecedingComment
